...
$phome_db_username='lightgx';	//数据库用户名
$phome_db_password='admin123';	//数据库密码
$phome_db_dbname='lightgx';	//数据库名
$phome_db_char='gbk';	//设置默认编码
$phome_db_dbchar='gbk';	//数据库默认编码
$dbtbpre='phomelightgx_';	//数据表前缀
$ecmslang='gb';	//语言包

//页面编码设置
$phome_ecms_charver='gb2312';	//安装帝国CMS的编码版本
...
$do_ecookiernd='3GTT3egnXBxXShPH4XeaiQJ34Cryq8';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$phome_cookievarpre='rngft';		//前台cookie变量前缀
$phome_cookieadminvarpre='kavka';		//后台cookie变量前缀
$phome_cookieckrnd='AJtH45mvvPJ6V4Y8jY8fFhCwrU46L5';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'光线时代（北京）数码科技有限公司',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'Bj4ZDHyfQsA6CtqeYQJpS49wwwRe7a',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/\">网站首页</a>&nbsp;|&nbsp;<a href=\"/gywm/\">关于我们</a>&nbsp;|&nbsp;<a href=\"/zpxs/\">作品欣赏</a>&nbsp;|&nbsp;<a href=\"/ywfw/\">业务范围</a>&nbsp;|&nbsp;<a href=\"/zprc/\">招聘人才</a>&nbsp;|&nbsp;<a href=\"/lxwm/\">联系我们</a>&nbsp;|&nbsp;<a href=\"/home/\">HOME</a>&nbsp;|&nbsp;<a href=\"/about/\">ABOUT US</a>&nbsp;|&nbsp;<a href=\"/Gallery/\">GALLERY</a>&nbsp;|&nbsp;<a href=\"/Offerings/\">OFFERINGS</a>&nbsp;|&nbsp;<a href=\"/Career/\">CAREER</a>&nbsp;|&nbsp;<a href=\"/CONTACT/\">CONTACT US</a>',
'plgroupid'=>0,
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
...
'listtempf'=>',title,ftitle,newstime,titlepic,smalltext,newstext,diggtop,',
...
'definfovoteid'=>0,
'orderf'=>'',
'sonclass'=>'|1|2|4|5|6|8|9|10|12|13|14|15|16|18|20|21|22|24|25|26|28|29|30|31|32|',
'tid'=>1,
'tbname'=>'news');
