...
E_D("DROP TABLE IF EXISTS `phomelightgx_enewspostserver`;");
E_C("CREATE TABLE `phomelightgx_enewspostserver` (
...
E_D("replace into `phomelightgx_enewspostserver` values('1','¸½¼þ·þÎñÆ÷','','1','','','','','','0','0','0','0','0');");
