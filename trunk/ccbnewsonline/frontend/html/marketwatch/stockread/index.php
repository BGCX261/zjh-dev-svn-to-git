...
$dataCPBD = ccb_drupal_query_page_by_category('030201_CPBD', 12, $conn);
...
<div class="left_3">
    <div class="location">加华财经在线：<a href="/">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="http://www.acbnewsonline.com.au/html/financialnews/">金融市场</a> > <a href="http://www.acbnewsonline.com.au/html/financialnews/australianews/">操盘必读</a> > </div>
    <div class="tit2"><div class="tit2_name">加国财经</div></div>
	
    <ul class="newslist_01">
        <?php
			ccb_news_output_brief_list($dataCPBD);
		?>
   </ul>
