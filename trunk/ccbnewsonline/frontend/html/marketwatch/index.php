...
$category = array("ca"=>"", "us"=>"", "eu"=>"", "as"=>"", "energy"=>"", "metals"=>"", "grain"=>"", "currency"=>"");
$iframePage = "";
$href = array("ca"=>"index.php?cat=ca",
			  "us"=>"index.php?cat=us",
			  "eu"=>"index.php?cat=eu",
			  "as"=>"index.php?cat=as",
			  "energy"=>"index.php?cat=energy",
			  "metals"=>"index.php?cat=metals",
			  "grain"=>"index.php?cat=grain",
			  "currency"=>"index.php?cat=currency");
if($cat == "ca")
{
	$category["ca"] = $classStyle;
	$iframePage = "stocks_canada_tsx.php";
}
elseif ($cat == "us")
{
	$category["us"] = $classStyle;
	$iframePage = "stocks_us_list.php";
}
elseif ($cat == "eu")
{
	$category["eu"] = $classStyle;
	$iframePage = "stocks_europe.php";
}
elseif ($cat == "as")
{
	$category["as"] = $classStyle;
	$iframePage = "stocks_asia.php";
}
elseif ($cat == "energy")
{
	$category["energy"] = $classStyle;
	$iframePage = "energy.php";
}
elseif ($cat == "metals")
{
	$category["metals"] = $classStyle;
	$iframePage = "metals.php";
}
elseif ($cat == "grain")
{
	$category["grain"] = $classStyle;
	$iframePage = "grain.php";
}
elseif ($cat == "currency")
{
	$category["currency"] = $classStyle;
	$iframePage = "currency.php";
}
else
{
	$category["ca"] = $classStyle;
...
<div class="ht_daohang">
    <div class="ht_menu">
       <ul>
            ...
            <li><a href="../../html/listedcompanies.html" ><span class="zw">上市公司</span><br /><span class="yw">Market Watch</span></a></li>
                        <li class="line"></li>
            <li><a href="../../html/businessinvestment" ><span class="zw">项目投资</span><br /><span class="yw">Business Investment</span></a></li>
                        <li class="line"></li>
            <li><a href="../../html/bridgetochina.html" ><span class="zw">加中连线</span><br /><span class="yw">bridge to china</span></a></li>
                        <li class="line"></li>
            <li><a href="../../html/financestudying" ><span class="zw">金融学堂</span><br /><span class="yw">Finance Satuding</span></a></li>
                        <li class="line"></li>
    ...
    <div class="gshq_content" style="float:left; width:200px;">
        <div class="gshq_left" style="height:540px">
            <ul class="fllist3">
                ...
                <li <?php echo $category["ca"]; ?>><a href="<?php echo $href["ca"]; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;加国股市</a></li>
                <li <?php echo $category["us"]; ?>><a href="<?php echo $href["us"]; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;美股行情</a></li>
                <li <?php echo $category["eu"]; ?>><a href="<?php echo $href["eu"]; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;欧洲股市</a></li>
                <li <?php echo $category["as"]; ?>><a href="<?php echo $href["as"]; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;亚洲股市</a></li>
                <li><a style="font-size: 16px; font-weight: bold">期货市场</a></li>
                <li <?php echo $category["energy"]; ?>><a href="<?php echo $href["energy"]; ?>">能源</a></li>
                <li <?php echo $category["metals"]; ?>><a href="<?php echo $href["metals"]; ?>">金属</a></li>
                <li <?php echo $category["grain"]; ?>><a href="<?php echo $href["grain"]; ?>">农产品</a></li>
                <li <?php echo $category["currency"]; ?>><a style="font-size: 16px; font-weight: bold" href="<?php echo $href["currency"]; ?>">外汇市场</a></li>
            </ul>
        </div>
    </div>
        ...
        <div style="width:100%; padding:20px 0px;">
            <span style="font-size: 14px">
                <span style="font-family: 宋体">
                    <iframe class="ht_content_market" name=”content_frame” marginwidth=0 marginheight=0 width=100% height=700 src="<?php echo $iframePage; ?>" frameborder=0></iframe>
                </span>
            </span>
        </div>        
    </div>
    ...
    <div class="ht_shichangzongshu">
        <div class="tit" style="margin-top:7px;"><span class="tit_more"><a href="./marketbrief">更多>></a></span><span class="tit_name">市场综述</span></div>
    ...
    <div class="ht_caopanbidu">
        <div class="tit" style="margin-top:7px;"><span class="tit_more"><a href="./stockread">更多>></a></span><span class="tit_name">操盘必读</span></div>
        <ul class="newslist" style="margin-top:10px;">
			<?php
