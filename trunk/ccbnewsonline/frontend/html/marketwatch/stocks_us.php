    ...
    <div class="gshq_content" style="float:left; width:200px;">
        <div class="gshq_left" style="height:540px">
            <ul class="fllist3">
                ...
                <li><a href="index.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;加国股市</a></li>
                <li class="pagexz"><a href="stocks_us.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;美股行情</a></li>
        ...
        <div style="width:100%; padding:20px 0px;">
            <span style="font-size: 14px">
                <span style="font-family: 宋体">
                    <iframe class="ht_content_market" name=”content_frame” marginwidth=0 marginheight=0 width=100% height=700 src="./stocks_us_list.php" frameborder=0></iframe>
                </span>
            </span>
        </div>        
    </div>
