#ifndef _UI_BUTTON_REVEAL_H_
#define _UI_BUTTON_REVEAL_H_

#include <UI/UIWidget.h>
#include <UI/UIButton.h>

class UIButtonReveal : public UIButton
{
public:
	UIWIDGET_DEF(UIButtonReveal, UIWidget)

public:
	UIButtonReveal();
	UIButtonReveal(UIWidget* pParent);
	virtual ~UIButtonReveal();
