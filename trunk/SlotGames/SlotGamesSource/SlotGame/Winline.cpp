...
//************************************
GTDictionary<int, GTArray<int> >* Winline::GetWinlines()
{
	...
	return winlineLoader->GetWinlines();
...
//************************************
GTDictionary<int, WinlineValue> Winline::CalculateWinLines(GTArray<int> srcSlots, int wildSymbolID)
{
...
//************************************
GTDictionary<int, int>* Winline::GetPaytable()
{
	GTGameObject* pWinlineLoaderObj = NULL;	
	BSWinlineLoader* winlineLoader = NULL;
	...
	return winlineLoader->GetPaytable();
...
//************************************
GTDictionary<int, int> Winline::CalculateWinPrize(GTDictionary<int, WinlineValue> winlinesDict, int& totalWin)
{
	//initialize 
...
//************************************
void Winline::ConvertPaytableKey(int key, int& winCount, int& winSymbol)
{
	winCount = (int)(key/100);
	winSymbol = (int)((key - 100 * winCount)%10);
}

int Winline::ConvertWinlineValueToPaytableKey(int winCount, int winSymbol)
{
