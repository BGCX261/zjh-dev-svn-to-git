...
bool GTGameObject::Copy(GTObject* pObjectFrom)
{
	...
	SetVisible(pGameObjectSrc->GetVisible());
...
int32 GTGameObject::OnInitialize(void)
{
	return 1;
}
...
void GTGameObject::OnVisible(void)
{
	GTGAMEOBJECT_ON_CALL_METHOD(OnVisible);
}


// OnBecameVisible is called when the the object is set invisible.
void GTGameObject::OnInvisible(void)
{
	GTGAMEOBJECT_ON_CALL_METHOD(OnInvisible);
}
...
// Set visible
void GTGameObject::SetVisible(bool visible)
{
	m_bVisible = visible;
	if(m_bVisible)
	{
...
GTBehaviour* GTGameObject::AddBehaviour(const tchar* szBehaviourClassName, GTBehaviourInitParam* param)
{
...
GTBehaviour* GTGameObject::AddComponent(const tchar* szBehaviourClassName, GTBehaviourInitParam* param)
{
