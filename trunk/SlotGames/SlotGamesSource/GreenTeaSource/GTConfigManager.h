#ifndef _GREENTEA_CONFIG_MANAGER_H_
#define _GREENTEA_CONFIG_MANAGER_H_

#include <GTGreenTea.h>

class GTConfigManager : public GTSingleton<GTConfigManager>
{
public:
	GTConfigManager();
	~GTConfigManager();
...
#endif /* _GREENTEA_CONFIG_MANAGER_H_ */
