...
GTTweenFunction GTTweenInterpolation::GetFunctionByType(const int32 type)
{
	switch(type)
	{
...
float GTTweenInterpolation::Linear(float from, float change, float factor)
{
	return change * factor + from;
}

float GTTweenInterpolation::SinusoidalEaseIn(float from, float change, float factor)
{
	return -change * Mathf_Cos(factor * (Mathf_PI * 0.5f)) + change + from;
}

float GTTweenInterpolation::SinusoidalEaseOut(float from, float change, float factor)
{
	return change * Mathf_Sin(factor * (Mathf_PI * 0.5f)) + from;
}

float GTTweenInterpolation::SinusoidalEaseInOut(float from, float change, float factor)
{
	return -change * 0.5f * (Mathf_Cos(Mathf_PI * factor) - 1) + from;
}

float GTTweenInterpolation::QuinticEaseIn(float from, float change, float factor)
{
	return change * Mathf_Pow(factor, 5) + from;
}

float GTTweenInterpolation::QuinticEaseOut(float from, float change, float factor)
{
	return change * (Mathf_Pow((factor - 1.0f), 5) + 1) + from;
}

float GTTweenInterpolation::QuinticEaseInOut(float from, float change, float factor)
{
	if ((factor *= 2.0f) < 1)
	{
...
float GTTweenInterpolation::QuarticEaseIn(float from, float change, float factor)
{
	return change * Mathf_Pow(factor, 4) + from;
}

float GTTweenInterpolation::QuarticEaseOut(float from, float change, float factor)
{
	return -change * (Mathf_Pow((factor - 1.0f), 4) - 1) + from;
}

float GTTweenInterpolation::QuarticEaseInOut(float from, float change, float factor)
{
	if ((factor *= 2.0f) < 1)
	{
...
float GTTweenInterpolation::QuadraticEaseIn(float from, float change, float factor)
{
	return change * factor * factor + from;
}

float GTTweenInterpolation::QuadraticEaseOut(float from, float change, float factor)
{
	return -change * factor * (factor - 2) + from;
}

float GTTweenInterpolation::QuadraticEaseInOut(float from, float change, float factor)
{
	if ((factor *= 2) < 1)
	{
...
float GTTweenInterpolation::ExponentialEaseIn(float from, float change, float factor)
{
	return (factor == 0.0f) ? from : change * Mathf_Pow(2, 10 * (factor - 1)) + from;
}

float GTTweenInterpolation::ExponentialEaseOut(float from, float change, float factor)
{
	return (factor == 1.0f) ? from + change : change * (-Mathf_Pow(2, -10 * factor) + 1) + from;
}

float GTTweenInterpolation::ExponentialEaseInOut(float from, float change, float factor)
{
	if (factor == 0.0f)
	{
		return from;
...
float GTTweenInterpolation::ElasticEaseIn(float from, float change, float factor)
{
	if (factor == 0.0f)
	{
		return from;
...
float GTTweenInterpolation::ElasticEaseOut(float from, float change, float factor)
{
	if (factor == 0.0f)
	{
		return from;
...
float GTTweenInterpolation::ElasticEaseInOut(float from, float change, float factor)
{
	if (factor == 0.0f)
	{
		return from;
...
float GTTweenInterpolation::CubicCubicEaseIn(float from, float change, float factor)
{
	return change * Mathf_Pow(factor, 3) + from;
}

float GTTweenInterpolation::CubicEaseOut(float from, float change, float factor)
{
	return change * (Mathf_Pow(factor - 1, 3) + 1) + from;
}

float GTTweenInterpolation::CubicEaseInOut(float from, float change, float factor)
{
	if ((factor *= 2) < 1)
	{
...
float GTTweenInterpolation::CircularEaseIn(float from, float change, float factor)
{
	return -change * Mathf_Sqrt(1 - (factor * factor) - 1) + from;
}

float GTTweenInterpolation::CircularEaseOut(float from, float change, float factor)
{
	return change * Mathf_Sqrt(1 - (factor -= 1) * factor) + from;
}

float GTTweenInterpolation::CircularEaseInOut(float from, float change, float factor)
{
	if ((factor *= 2) < 1)
	{
...
float GTTweenInterpolation::BounceEaseOut(float from, float change, float factor)
{
	if ((factor) < (1 / 2.75))
	{
...
float GTTweenInterpolation::BounceEaseIn(float from, float change, float factor)
{
	return change - BounceEaseOut(0, change, 1.0f - factor) + from;
}

float GTTweenInterpolation::BounceEaseInOut(float from, float change, float factor)
{
	if (factor < 0.5f)
	{
...
/// A <see cref="System.Single"/>
/// </returns>
float GTTweenInterpolation::BackEaseIn(float from, float change, float factor)
{
...
/// A <see cref="System.Single"/>
/// </returns>
float GTTweenInterpolation::BackEaseOut(float from, float change, float factor)
{
...
/// A <see cref="System.Single"/>
/// </returns>
float GTTweenInterpolation::BackEaseInOut(float from, float change, float factor)
{
	float s = 1.70158f;
	if ((factor *= 2) < 1)
	{
