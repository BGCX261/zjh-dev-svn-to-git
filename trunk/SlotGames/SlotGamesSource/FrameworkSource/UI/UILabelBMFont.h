...
public:
	...
	// Initialize the font
	virtual bool Initialize(const char* szFontName, const int32 nZOrder) = 0;
	virtual bool Initialize(const char* szText, const char* szFontName, const int32 nZOrder) = 0;
	// Set the text
