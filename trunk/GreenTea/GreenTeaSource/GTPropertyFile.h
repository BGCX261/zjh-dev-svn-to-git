#ifndef _GREENTEA_PROPERTY_FILE_H_
#define _GREENTEA_PROPERTY_FILE_H_
...
#define PROPERTYFILE_TAG_IMP(tagName) const tchar* GTPropertyFile::Tag##tagName = CTEXT(#tagName);

class GTPropertyFile
{
public:
	GTPropertyFile();
	~GTPropertyFile();
...
public:
	...
	static const tchar* TagTypeV1;
	static const tchar* TagTypeV2;
	// U
	...
	// Z
	PROPERTYFILE_TAG_DEF(ZOrder);
};

#endif /* _GREENTEA_PROPERTY_FILE_H_ */
