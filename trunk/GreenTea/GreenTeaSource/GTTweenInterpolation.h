#ifndef _GREENTEA_TWEEN_INTERPOLATION_H_
#define _GREENTEA_TWEEN_INTERPOLATION_H_
...
typedef float (*GTTweenFunction)(float v0, float v1, float factor);

class GTTweenInterpolation
{
public:
	// Tween type
	...
	// Get GTTweenFunction from the type
	static GTTweenFunction GetFunctionByType(const int32 type);
...
#endif /* _GREENTEA_TWEEN_INTERPOLATION_H_ */
