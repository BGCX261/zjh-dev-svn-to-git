#ifndef _GREENTEA_INPUT_MANAGER_H_
#define _GREENTEA_INPUT_MANAGER_H_
...
class GTInputManager : public GTSingleton<GTInputManager>
{
private:
...
public:
	GTInputManager();
	GTInputManager(const GTInputManager& im);
	virtual ~GTInputManager();
...
#endif /* _GREENTEA_INPUT_MANAGER_H_ */
