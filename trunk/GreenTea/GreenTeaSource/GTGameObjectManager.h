...
public:
	...
	bool InitializeGameObjectFromPropertyFile(GTGameObject *pGameObject, const tchar* szPropertyFileName);
	// Initialize a game object with a GTTreeNode
	bool InitializeGameObjectFromTreeNode(GTGameObject *pGameObject, GTTreeNode* pTreeNode, const tchar* szObjectName);
	...
	GTGameObject* CreateGameObjectByClassName(GTGameObject* pParent, const tchar* szName, const tchar* szClassName);
