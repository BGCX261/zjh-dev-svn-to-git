...
int32 BSSpriteMovement::OnInitialize(GTBehaviourInit* param)
{
...
void BSSpriteMovement::GetMovementPathNode(const int32 nStartIndex)
{
	...
	// Play proper moving animation with correct direction
	((GameObjectSprite*)m_pGameObject)->m_pSprite->PlayAnimationByName(
