#ifndef _BS_SPRITE_STATIC_H_
#define _BS_SPRITE_STATIC_H_

#include <GTBehaviour.h>
#include <GTTreeNode.h>
#include "../Sprite/GSprite.h"

class BSStaticSprite : public GTBehaviour
{
public:
	GTBEHAVIOUR_DEF(BSStaticSprite, GTBehaviour);

public:
	BSStaticSprite();
	virtual ~BSStaticSprite();
