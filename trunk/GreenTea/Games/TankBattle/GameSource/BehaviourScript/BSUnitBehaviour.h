...
public:
	...
	{
		return m_pGameObjectSprite ? m_pGameObjectSprite->IsAnimationPlaying() : false;
	}
	...
	{
		return m_pGameObjectSprite ? m_pGameObjectSprite->PlayAnimationByName(szAnimationName, nFlags, pCallback, pCallbackThis, pCallbackParam) : false;
	}
	bool PlayAnimationByName(const tchar* szAnimationName, const uint32 nFlags)
	{
		return m_pGameObjectSprite ? m_pGameObjectSprite->PlayAnimationByName(szAnimationName, nFlags) : false;
	}
	...
	{
		return m_pGameObjectSprite ? m_pGameObjectSprite->PlayAnimationByIndex(index, nFlags, pCallback, pCallbackThis, pCallbackParam) : false;
	}
	bool PlayAnimationByIndex(const int32 index, const uint32 nFlags)
	{
		return m_pGameObjectSprite ? m_pGameObjectSprite->PlayAnimationByIndex(index, nFlags) : false;
	}
