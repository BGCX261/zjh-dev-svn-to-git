...
#include "CCEGLView.h"
#include "../../../cocos2dx/cocos2dx/platform/CCEGLViewProtocol.h"
// Game
...
bool AppDelegate::applicationDidFinishLaunching()
{
	...
	*/
	...
	ScreenManager::GetInstance()->SetScreenSize((uint32)designResolutionSize.width, (uint32)designResolutionSize.height);
	...
	*/
	...
	CCLog("contentScale = %f", CCDirector::sharedDirector()->getContentScaleFactor());
	CCLog("frameSize.width = %f, height = %f", frameSize.width, frameSize.height);
	CCLog("designResolutionSize.width = %f, height = %f", designResolutionSize.width, designResolutionSize.height);
