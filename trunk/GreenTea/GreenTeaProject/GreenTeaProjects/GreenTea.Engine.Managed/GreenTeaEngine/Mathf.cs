...
namespace GreenTeaEngine
{
    public struct GTMathf
    {
        ...
        internal static bool LineIntersection(GTVector2 p1, GTVector2 p2, GTVector2 p3, GTVector2 p4, ref GTVector2 result)
        {
            float num = p2.x - p1.x;
            ...
            result = new GTVector2(p1.x + (num8 * num), p1.y + (num8 * num2));
            return true;
        }

        internal static bool LineSegmentIntersection(GTVector2 p1, GTVector2 p2, GTVector2 p3, GTVector2 p4, ref GTVector2 result)
        {
            float num = p2.x - p1.x;
            float num2 = p2.y - p1.y;
            float num3 = p4.x - p3.x;
