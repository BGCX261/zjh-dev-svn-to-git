...
namespace GreenTeaEngine
{
    public struct GTVector2
    {
        ...
        public float magnitude
        {
            get
            {
                return GTMathf.Sqrt((this.x * this.x) + (this.y * this.y));
            }
        }
        ...
        {
            return (GTMathf.Acos(GTMathf.Clamp(Dot(from.normalized, to.normalized), -1f, 1f)) * 57.29578f);
        }
        ...
        {
            return new GTVector2(GTMathf.Min(lhs.x, rhs.x), GTMathf.Min(lhs.y, rhs.y));
        }

        public static GTVector2 Max(GTVector2 lhs, GTVector2 rhs)
        {
            return new GTVector2(GTMathf.Max(lhs.x, rhs.x), GTMathf.Max(lhs.y, rhs.y));
        }
