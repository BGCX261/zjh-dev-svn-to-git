...
// SDK
#include <BaseDef.h>
// NewMem.h must be firstly included, otherwise it will
...
*/
class STDMOD TiXmlNode : public TiXmlBase
{
	friend class TiXmlDocument;
	friend class TiXmlElement;
...
*/
class STDMOD TiXmlElement : public TiXmlNode
{
public:
...
*/
class STDMOD TiXmlText : public TiXmlNode
{
	friend class TiXmlElement;
public:
	/// Constructor.
...
*/
class STDMOD TiXmlDocument : public TiXmlNode
{
public:
