...
public:
	...
	virtual bool PlayAnimationByName(const tchar* szAnimationName, const uint32 nFlags, GTObject_CallbackFunction pCallback) = 0;
	...
	virtual bool PlayAnimationByIndex(const int32 index, const uint32 nFlags, GTObject_CallbackFunction pCallback) = 0;
	// Flags: GSpriteAnimation::PlayMode_Loop/GSpriteAnimation::PlayMode_Once
