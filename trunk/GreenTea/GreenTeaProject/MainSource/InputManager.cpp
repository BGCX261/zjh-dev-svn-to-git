...
bool InputManager::ReleaseEventList(GTEventContainer *pEventList)
{
	if(NULL == pEventList)
	{
		return false;
...
// Unregister an event
bool InputManager::UnregisterEvent(const EventType eventType, const tchar* szName)
{
...
InputManager::GTEventContainer* InputManager::GetEventList(const int32 nEventType)
{
...
bool InputManager::OnEvent(GTEventContainer *pEventList,
						   const uint32 nFlags,
...
bool InputManager::OnSingleClickEvent(const uint32 nFlags, const GTPoint2& point)
{
...
// Double click event
// The original (0, 0) is at left-bottom of the screen
bool InputManager::OnDoubleClickEvent(const uint32 nFlags, const GTPoint2& point)
{
...
// Move event
// The original (0, 0) is at left-bottom of the screen
bool InputManager::OnMoveEvent(const uint32 nFlags, const GTPoint2& point)
{
