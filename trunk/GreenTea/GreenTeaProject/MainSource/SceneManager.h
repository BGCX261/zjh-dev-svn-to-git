...
public:
	...
	bool IntializeGameObject(GTGameObject *pGameObject, const tchar* szPropertyFileName);
	...
	bool IntializeGameObjectDefaultBehaviour(GTGameObject *pGameObject, GTTreeNode *pRootTreeNode);
	// Initialize a game object if it's a sprite object
	bool IntializeGameObjectSprite(GTGameObject *pGameObject, GTTreeNode* pRootTreeNode);
	bool IntializeGameObjectBehaviour(GTGameObject *pGameObject, GTTreeNode* pRootTreeNode);
	bool IntializeChildGameObject(GTGameObject *pParentGameObject, GTTreeNode* pParentTreeNode);
	bool IntializeChildrenGameObjects(GTGameObject *pGameObject, GTTreeNode* pRootTreeNode);
